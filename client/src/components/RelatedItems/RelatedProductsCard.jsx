...
class RelatedProductsCard extends React.Component {
  ...
  render() {
    ...
    // let price = ''
    // if (this.props.salesPrice != null) {
    //   price = <div className="price-wrapper">
    //     <div className="sale-price">{this.props.salesPrice}</div>
    //     <div className="default-price">{'$' + this.props.relatedProduct.default_price}</div>
    //   </div>
    // } else if (this.props.item && this.props.item.data.sale_price === null) {
    //   price = <div className="default-price">{'$' + this.props.relatedProduct.default_price}</div>
    ...
    let productCard =
      <div className="related-products-card" onClick={this.props.handleCardClick}>
        <img className="product-photo" src={this.props.relatedImage} alt="IMAGE NOT FOUND"></img>
